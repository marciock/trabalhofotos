...
import { NewuserProvider } from '../providers/newuser/newuser';
import {NovoComentariosPage} from '../pages/novo-comentarios/novo-comentarios';
@NgModule({
  declarations: [
    MyApp,
    HomePage,
  ...
  providers: [
    ...
    Geolocation,
    NovoUsuarioProvider,
    NewuserProvider //plugin de geolocalizacao
  ]
})
